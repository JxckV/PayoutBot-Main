To change the value of the payout you need to change two files. Mypayout.js and totalpayout.js. const totalPayout = Math.floor((userPercentage / 100) * 5_000_000).toLocaleString(); This line needs to be changed to what ever value you want it to be.

This is a re-developed version of Venni's STRP Payout Bot. If you are looking to host this bot and don't know fuck all on how to setup message me on discord (If you are looking to go down the route of hosting this from myself this will cost as i pay for server hardware solely to do this)
...
I've already done 3 for you. I didn't want to share the values that other gangs are currently using as they would just figure out what makes the most and do that so cba. /
